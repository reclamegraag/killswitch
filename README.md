...
- Global shortcut: **Win + Alt + S** to activate the window from anywhere
...
| Plugins  | tauri-plugin-autostart, tauri-plugin-global-shortcut |

## Keyboard Shortcuts

| Shortcut        | Action                        |
| --------------- | ----------------------------- |
| Win + Alt + S   | Show and focus KillSwitch     |
